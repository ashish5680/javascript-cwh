...
// Using JS Objects -> Exercise 5: Solution
console.log("\n");



// Reference of JSON -> https://www.wordsapi.com/
...
const myJson = `{
  ...
  // JSON ko object mai parse karne ke liye
  const myObj = JSON.parse(myJson);            // agar JSON valid JSON hai too we see like this in console -> The object is : {word: 'example', results: Array(6), syllables: {…}, pronunciation: {…}, frequency: 4.67}
